...
* ~~a look around the files here. Where are the R scripts? What are the directories `data` and `figs` for?~~
...
The goal of packages-report is to report on nature of user installed packages.
...
read_csv(here("data","add-on-packages-freqtable.csv")) %>% knitr::kable(format = "html")
